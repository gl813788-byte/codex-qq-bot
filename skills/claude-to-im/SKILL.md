...
| `src/qq-cross-session.js` | Catalog known group/private sessions, resolve stable selectors and safely rebind the verified role without copying inbound message context. |
